...
Este sistema tiene la finalidad de crear tarjetas de Rick and Morty, utilizando **JavaScript** de forma asíncrona con **fetch(), then() y catch()**.  Obtenemos todos los datos de la **API de Rick and Morty** la cual nos brinda la siguiente información:
